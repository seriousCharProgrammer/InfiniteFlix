...
const OriginalPage = () => {
  ...
  const fetchMovies = useCallback(async () => {
    ...
    setLoading(true);
    try {
      const API_URL = `https://api.themoviedb.org/3/discover/movie?api_key=${process.env.REACT_APP_API_KEY}&primary_release_date.gte=1995-01-01&primary_release_date.lte=2012-12-31&include_adult=false&sort_by=popularity.desc&page=${page}`;
